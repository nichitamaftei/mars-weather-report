...
def getWeatherFromMars(): # this function gets the data from NASA's restful api
    ...
    # checks and loads any .env files
    load_dotenv()

    # get the API key from either cli env variables or from a .env file
    apiKey = os.getenv("NASA_API_KEY")

    if not apiKey:
        raise ValueError("API_KEY is missing, please add your NASA API key as an environment variable or in a .env file")
